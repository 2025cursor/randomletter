...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${BASE_URL}/picker-generator`,
  },
  openGraph: {
    title: 'Random List Picker - Free Random Selection Tool',
    description: 'Enter your list and randomly pick one or more items. Perfect for decisions, raffles, and random selections.',
    url: `${BASE_URL}/picker-generator`,
  },
}
